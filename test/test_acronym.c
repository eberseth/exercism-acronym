...
static void test_prefixed_whitespace_abbreviation(void)
{
   //TEST_IGNORE();
   char* phrase = " I cast you out!";
   char* expected = "ICYO";
   test_abbreviation(phrase, expected);
}

static void test_suffixed_whitespace_abbreviation(void)
{
   //TEST_IGNORE();
   char* phrase = "What an excellent day for an exercism ";
   char* expected = "WAEDFAE";
   test_abbreviation(phrase, expected);
}
...
int main(void)
{
   ...
   RUN_TEST(test_prefixed_whitespace_abbreviation);
   RUN_TEST(test_suffixed_whitespace_abbreviation);
   return UnityEnd();
}
